...
public class AquarioTesteEstruturalFluxoDados {
	...
	@Test
	void testeInicializa1(){//todos os arcos
	...
	@Test
	void testeInicializa2(){//todos os nos
	...
	@Test
	void testeMovimenta1(){//{1,3,5,7,9,10,11,13}
		System.out.println("Teste 1");
		Aquario aquario = new Aquario(2,2,1,1,1,1);//cria aquario
		aquario.inicializar(2,2);//inicializa aquario			
	...
	@Test
	void testeAtualizaPosMov(){//{1,2,3}
		System.out.println("Teste 1");
		Aquario aquario = new Aquario(2,2,1,1,1,1);//cria aquario
		aquario.inicializar(2,2);//inicializa aquario			
	...
	@Test
	void testeVerificaFim1(){//{1,3,4,5,9}
		System.out.println("Teste 1");
		Aquario aquario = new Aquario(2,2,1,1,1,1);//cria aquario
		aquario.inicializar(2,2);//inicializa aquario			
